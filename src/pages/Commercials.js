...
class Commercials extends React.Component{
    ...
    this.setState({
      new_trash: new_trash,  // New object with updated property.
		}, () => {
			// console.log(this.state.new_trash);
		});
	}
				...
				<div className="grid-x grid-margin-x">
					...
					<div className='cell'>
						...
						<Table celled striped compact size='small' unstackable>
							...
							<Table.Body>
							<TableBodyLoader loading={ this.state.loading } cols={4} message="Loading Commercials..." slow={false} />
										...
										<Table.Row key={ trash['trash_id'] || '' }>
											...
											<Table.Cell collapsing>
												<Button.Group basic size='small'>
													<TableActionButton link={false} actionName={ 'This is NOT a Commercial' } actionIcon='trash' onClick={ ()=> { this.removeFromCommercials(trash['trash_id']) }}/>
												</Button.Group>
											</Table.Cell>
										</Table.Row>
									)
