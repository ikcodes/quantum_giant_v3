		...
		<Segment id="HomePage" className="page">
			<div className="grid-x grid-margin-x">
				<PageHeader 
					...
					link="/"
					iconName="home"
					instructions="Welcome to Quantum Giant!"
				/>
				...
				<div className="grid-x grid-margin-x grid-padding-x">
					<div className="cell small-12" style={{marginBottom: '30px'}}>
						<div className="pageHeader">
							<h1 style={{letterSpacing:'-1px'}}><Icon className="pageIcon" name="clone"></Icon>Current Releases</h1>
							<p className="instructions">Albums with a release date in the past 3 months.  Included in marketing reports.</p>
						</div>
					...
					<div className="cell small-12" style={{marginBottom: '30px'}}>
						<div className="pageHeader">
							<h1 style={{letterSpacing:"-1px"}}><Icon className="pageIcon" name="clone"></Icon>Upcoming Releases</h1>
					...
					<div className="cell small-12" style={{marginBottom: '30px'}}>
						<div className="pageHeader">
							<h1 style={{letterSpacing:"-1px"}}><Icon className="pageIcon" name="clone"></Icon>Albums Missing Data</h1>
							<p className="instructions">These albums are missing a proper release date or are unassigned to a label. <br />To get the most out of the app, please update any albums you see here with the correct release date or label imprint.</p>
						</div>
						<div className="grid-x">
							<div className="cell small-12 table-scroll">
								<Table celled compact striped size='small' unstackable>
