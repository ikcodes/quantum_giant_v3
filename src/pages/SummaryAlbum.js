...
class AlbumSummary extends React.Component {
            ...
            if (res.data.name) {
              this.setState(
                ...
                () => {
                  ...
                  axios
                    .post(config.get("api_url") + "summary/album-custom", postData)
                    .then((res) => {
  ...
  queryForSummary() {
    ...
    if (queryValues.album_id) {
      ...
      console.log("We need an album ID to properly execute!");
    }
  }
        ...
        <div>
          ...
          <p>
            ...
            <a
              ...
              href={"/search?album_title=" + encodeURI(this.state.album_title)}
            >
      ...
      <Segment id='spinSummary' className='page'>
        <div className='grid-x grid-margin-x'>
          ...
          <div style={displayCustomDates} className='cell medium-7 large-9 ui form'>
            ...
            <div className='grid-x align-middle'>
              <div className='cell'>
                <Button id='queryCustomDates' onClick={this.queryCustom} primary>
                  Query Custom Dates
                </Button>
              </div>
            </div>
