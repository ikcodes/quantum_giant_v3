              ...
              <div className='cell large-8'>
                <div className='grid-x grid-margin-x' style={{ position: "relative" }}>
                  ...
                  <div className='cell large-6' style={{ marginTop: 15 }}>
                    ...
                    <Button style={{ width: "100%" }} onClick={this.updateTopAlbums} primary>
                      Go!
                    </Button>
                  </div>
                        ...
                        <Table.Row key={index}>
                          ...
                          <Table.Cell textAlign='center'>
                            <Button.Group basic size='small'>
                              <TableActionButton
                                link={summaryLink}
                                actionName={"View Album Summary for " + spin_count["album_title"]}
                                actionIcon='pie chart'
                              />
                            </Button.Group>
                          </Table.Cell>
                        </Table.Row>
