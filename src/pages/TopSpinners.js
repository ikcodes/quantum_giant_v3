  ...
  updateTopSpinners() {
    this.setState(
      ...
      () => {
        ...
        axios
          .post(config.get("api_url") + "top-spinners/get-top-spinners", postData)
          .then((res) => {
            if (res.data.summary) {
              this.setState(
                {
              ...
              <div className='cell large-8'>
                <div className='grid-x grid-margin-x' style={{ position: "relative" }}>
                  ...
                  <div className='cell large-6' style={{ marginTop: 15 }}>
                    ...
                    <Button style={{ width: "100%" }} onClick={this.updateTopSpinners} primary>
                      Go!
                    </Button>
                  </div>
                        ...
                        <Table.Row key={index}>
                          ...
                          <Table.Cell textAlign='center'>
                            <Button.Group basic size='small'>
                              <TableActionButton
                                link={searchUrl}
                                actionName={"Search Spins For " + spin_count["artist_name"]}
                                actionIcon='search'
                              />
                            </Button.Group>
                          </Table.Cell>
