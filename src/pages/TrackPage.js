...
function TrackPage(){
	...
	// let addForAlbum = urlChunks[2] === 'add' && urlChunks[3] === 'album' ? parseInt(urlChunks[4]) : null;
	// let addForArtist = urlChunks[2] === 'add' && urlChunks[3] === 'artist' ? parseInt(urlChunks[4]) : null;
	...
	return(
		<Switch>
			<Route path={`${match.path}/edit`}>
				{/* <Segment id="trackEdit" className="page grid-container"> */}
			...
			<Route path={`${match.path}/album`}>
				{/* <Segment id="trackView" className="page grid-container"> */}
