...
class Upload extends React.Component {
  ...
  render() {
    ...
    var resultsMarkup =
      Object.keys(this.state.api_response).length === 0 &&
      this.state.api_response.constructor === Object ? (
        ""
      ) : (
        <div>
          <h3 style={{ textTransform: "uppercase", color: "#413a5f" }}>Complete!</h3>
          <p style={{ marginBottom: 5 }}>
            <strong>Artists Created:</strong> {this.state.api_response.artists_created || "0"}
          </p>
          <p style={{ marginBottom: 5 }}>
            <strong>Albums Created:</strong> {this.state.api_response.albums_created || "0"}
          </p>
          <p style={{ marginBottom: 5 }}>
            <strong>Tracks Created:</strong> {this.state.api_response.tracks_added || "0"}
          </p>
          <p style={{ marginBottom: 5 }}>
            <strong>Tracks Skipped:</strong> {this.state.api_response.tracks_skipped || "0"}
          </p>
        </div>
      );
          ...
          <div className='cell'>
            ...
            <div className='grid-x'>
              <div className='cell large-8'>
                <label>
                  <strong>Release Date (required)</strong>
                </label>
                <DateFiltering
            ...
            <Button primary type='submit' onClick={this.handleFile}>
              Upload Metadata
            </Button>
          </div>
